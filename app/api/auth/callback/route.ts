...
export async function GET(req) {
  ...
  try {
    // นำ code ไปแลกกับ Access Token จาก LINE
    const tokenResponse = await fetch('https://api.line.me/oauth2/v2.1/token', {
      ...
      body: new URLSearchParams({
        ...
        code: code,
        // สำคัญ: ลิงก์นี้ต้องตรงกับที่กรอกในหน้า LINE Developers แบบ 100%
    ...
    // ดักจับ Error ตรงนี้เพื่อให้เห็นสาเหตุที่แท้จริงบน Vercel Logs
